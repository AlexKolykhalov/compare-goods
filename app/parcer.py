...
def get_news():
    ...
    # Label: "COMODO RSA Domain Validation Secure Server CA"
    ...
    # SHA256 Fingerprint: 02 AB 57 E4 E6 7A 0C B4 8D D2 FF 34 83 0E 8A C4 0F 44 76 FB 08 CA 6B E3 F5 CD 84 6F 64 68 40 F0
    -----BEGIN CERTIFICATE-----
    MIIGCDCCA/CgAwIBAgIQKy5u6tl1NmwUim7bo3yMBzANBgkqhkiG9w0BAQwFADCB
    hTELMAkGA1UEBhMCR0IxGzAZBgNVBAgTEkdyZWF0ZXIgTWFuY2hlc3RlcjEQMA4G
    A1UEBxMHU2FsZm9yZDEaMBgGA1UEChMRQ09NT0RPIENBIExpbWl0ZWQxKzApBgNV
    ...
    with open('./usercert.pem', 'w') as req_file:
        print(req_file.write(user_cert_pem1))

    with open('./usercert.pem', 'r') as req_file:
        print(req_file.read())
