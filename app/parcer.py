...
def MAGNIT():
    ...
    for product in products:
        ...
        title        = product_name.replace('ё', 'е').replace("'", '').replace('.', '').replace('Масло сливочное', 'Масло_сливочное').replace('Крабовые палочки', 'Крабовые_палочки').replace('Принглс', 'PRINGLES')
